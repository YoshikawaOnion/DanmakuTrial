...
public static class Def
{
    ...
    public static readonly float WorldXMax = ScreenWidth / 2 * UnitPerPixel;
    public static readonly float WorldYMax = ScreenHeight / 2 * UnitPerPixel;
    public static readonly float DownAngle = 180;
